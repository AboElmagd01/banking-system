...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="addAccount.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="card">
          <div class="card-header p-3 pt-2">
            ...
            <div class="text-end pt-1">
              ...
              <h4 class="mb-0"><?php echo  count($accounts)?></h4>
            </div>
          </div>
            ...
            <div class="table-responsive">
              <table class="table align-items-center mb-0">
                ...
                <tr>
                  ...
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">AccountNo</th>
                ...
                else
                {
                  ...
                  <td>
                    <div class="d-flex px-2 py-1">
                      <div>
                        <img src="../assets/img/small-logos/github.svg" class="avatar avatar-sm me-3" alt="xd">
                      </div>
                      <div class="d-flex flex-column text-end justify-content-center">
                        <h6 class="mb-0 text-sm">'.$account->Owner->name .'</h6>
                      </div>
                    </div>
                  </td>
                  <td>
                  ...
                  <td class="align-middle text-center text-sm">
                    <span class="text-xs font-weight-bold"> '.$account->id .'</span>
                  </td>                           
                  <td class="align-middle text-center text-sm">
                    <span class="text-xs font-weight-bold"> '.$account->type .'</span>
                  </td>                  
                  <td class="align-middle text-center text-sm">
                    <span class="text-xs font-weight-bold"> $'.$account->balance .'</span>
                  </td>

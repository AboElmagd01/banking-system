...
if (isset($_FILES['fingerprint'])){
    if(!empty($_FILES['fingerprint'])) {
        ...
        echo "PLease Upload your Fingerprint";
    }
}
?>
      ...
      <div class="col-12">
        ...
        <nav class="navbar navbar-expand-lg blur border-radius-xl top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid ps-2 pe-0">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="../Client/dashboard.php">
              Fingerprint ATM system
            </a>
            ...
            <div class="collapse navbar-collapse" id="navigation">
              <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center me-2 active" aria-current="page" href="../Client/dashboard.php">
              ...
              <div class="card-body">
                <form role="form" class="text-start" method="post" enctype="multipart/form-data" >
                  ...
                  <div class="input-group input-group-outline my-3">
                    <input name="fingerprint" type="file" class="form-control"  id="customFile" style="" required />
                  </div>
